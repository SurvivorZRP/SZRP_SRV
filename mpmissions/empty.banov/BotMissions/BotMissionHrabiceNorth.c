class BotMissionHrabiceNorth: MissionBase
{
	
	void BotMissionHrabiceNorth() { StartMissionAI(); }
	
	AIWorld world = GetGame().GetWorld().GetAIWorld();
	
	// Êîíôèãè áîòîâ
	vector BotSpawnPoint = "2044.01 268.742 12012.8";				// çàäàåì òî÷êó ñïàâíà áîòà	
	...
	void AddCeckPoint(SurvivorBotBase m_BotSolder)
	{
		...
		m_BotSolder.AddCheckpoint("2044.01 268.742 12012.8");
		m_BotSolder.AddCheckpoint("2127.8 268.742 12129.4");
		m_BotSolder.AddCheckpoint("2209.29 268.742 12135.9");
		m_BotSolder.AddCheckpoint("2145.5 268.742 11976.4");
		m_BotSolder.AddCheckpoint("2140.85 268.742 11882.5");
