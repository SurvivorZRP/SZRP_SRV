class BotMissionHrabiceGate: MissionBase
{
	
	void BotMissionHrabiceGate() { StartMissionAI(); }
	
	AIWorld world = GetGame().GetWorld().GetAIWorld();
	
	// Êîíôèãè áîòîâ
	vector BotSpawnPoint = "1768.15 268.13 11363.0";				// çàäàåì òî÷êó ñïàâíà áîòà	
	
	int m_botAcuracy = 5;											// Íàñòðîéêà ìåòêîñòè áîòà (÷åì âûøå ÷èñëî, òåì ÷àùå áîò ïðîìàçûâàåò)
	
	int BotSolderCountMin = 2;  										// íàçíà÷àåì ìèíèìàëüíîå êîëè÷åññòâî áîòîâ
	int BotSolderCountMax = 4;										// íàçíà÷àåì ìàêñèìàëüíîå êîëè÷åññòâî áîòîâ
	...
	bool isUseCheckPoints = false;										// çàäàåì èñïîëüçóþòñÿ ëè ÷åêïîíèíòû true - èñïîëüçóþòñÿ, fslse - íå èñïîëüçóþòñÿ
