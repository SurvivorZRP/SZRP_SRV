class BotMissionHrabiceSouth: MissionBase
{
	
	void BotMissionHrabiceSouth() { StartMissionAI(); }
	
	AIWorld world = GetGame().GetWorld().GetAIWorld();
	
	// Êîíôèãè áîòîâ
	vector BotSpawnPoint = "2123.32 268.742 11326.2";				// çàäàåì òî÷êó ñïàâíà áîòà	
	...
	void AddCeckPoint(SurvivorBotBase m_BotSolder)
	{
		...
		m_BotSolder.AddCheckpoint("2123.32 268.742 11326.2");
		m_BotSolder.AddCheckpoint("2015.13 268.742 11532.4");
		m_BotSolder.AddCheckpoint("2019.83 268.742 11621.1");
		m_BotSolder.AddCheckpoint("2140.48 268.742 11603.5");
