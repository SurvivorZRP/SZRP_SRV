class BotMissionArkariaChk: MissionBase
{
	
	void BotMissionArkariaChk() { StartMissionAI(); }
	
	AIWorld world = GetGame().GetWorld().GetAIWorld();
	
	// Êîíôèãè áîòîâ
	vector BotSpawnPoint = "6256.86 218.43 2106.85";				// çàäàåì òî÷êó ñïàâíà áîòà	
	
	int m_botAcuracy = 3;											// Íàñòðîéêà ìåòêîñòè áîòà (÷åì âûøå ÷èñëî, òåì ÷àùå áîò ïðîìàçûâàåò)
	
	int BotSolderCountMin = 8;  										// íàçíà÷àåì ìèíèìàëüíîå êîëè÷åññòâî áîòîâ
	int BotSolderCountMax = 12;										// íàçíà÷àåì ìàêñèìàëüíîå êîëè÷åññòâî áîòîâ
	
	int botLootCountMin = 4; 											// íàçíà÷àåì ìèíèìàëüíîå êîëè÷åñòâî ëóòà ó áîòà
	int botLootCountMax = 8; 										// íàçíà÷àåì ìàêñèìàëüíîå êîëè÷åñòâî ëóòà ó áîòà
	...
	bool onVoice = true;												// Âêëþ÷åíèå èëè îòêëþ÷åíèå ãîëîñà áîòà (âêëþ÷åíèå ýòîãî ïàðàìåòðà âûçûâàåò áîëüøå íàãðóçêè íà ñåðâåð)
	int m_spawnBotRadius = 100;										// Ðàäèóñ ñïàâíà áîòîâ íà òåðèòîðèå, öåíòðîì òåðèòîðèè ÿâëÿåòñÿ êîîðäèíàòà óêàçàííàÿ â BotSpawnPoint
	...
	void AddCeckPoint(SurvivorBotBase m_BotSolder)
	{
		...
		m_BotSolder.AddCheckpoint("6256.86 218.43 2106.85");
		m_BotSolder.AddCheckpoint("6215.13 215.205 2070.28");
		m_BotSolder.AddCheckpoint("6149.55 213.202 2005.7");
		m_BotSolder.AddCheckpoint("6165.59 213.322 2006.78");
		m_BotSolder.AddCheckpoint("6215.13 215.205 2070.28");
