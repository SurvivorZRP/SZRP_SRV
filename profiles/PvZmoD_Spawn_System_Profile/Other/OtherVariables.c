...
string missionNamePvz   = "empty.banov"; 
// This value allow the system to automatically spawn priests and butchers in churches and shops 
// (using "65" to "68" values in the .json file)
