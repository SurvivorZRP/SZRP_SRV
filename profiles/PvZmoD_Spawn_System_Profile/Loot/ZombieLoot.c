...
ref autoptr TStringArray zombieList_12 	= {"ZmbM_priestPopSkinny_Base",}; 
ref autoptr TStringArray itemList_12 	= {"1.0","Random","Cannabis","Cannabis","Marmalade","Bear_Pink","BookDeadSouls",};
ref autoptr TStringArray vestList_12 	= {"1.0","Random","Flag_Chernarus","Flag_Chedaki","Flag_NAPA","Flag_CDF","Flag_Livonia","Flag_Altis","Flag_SSahrani","Flag_NSahrani","Flag_DayZ","Flag_LivoniaArmy","Flag_White","Flag_Bohemia","Flag_APA","Flag_UEC","Flag_Pirates","Flag_Cannibals","Flag_Bear","Flag_Wolf","Flag_BabyDeer","Flag_Rooster","Flag_LivoniaPolice","Flag_CMC","Flag_TEC","Flag_CHEL","Flag_Zenit","Flag_HunterZ","Flag_BrainZ",};
ref autoptr TStringArray backList_12 	= {"0.0","Random","",};
ref autoptr TStringArray headgearList_12= {"0.5","Random","",};

ref autoptr TStringArray zombieList_13 	= {"ZmbM_DoctorFat_Base",}; 
ref autoptr TStringArray itemList_13 	= {"10.0","Random","Guts","HumanSteakMeat","Bone","Guts","HumanSteakMeat","Bone",};
ref autoptr TStringArray vestList_13 	= {"0.05","Random","MeatTenderizer",};
ref autoptr TStringArray backList_13 	= {"0.0","Random","",};
ref autoptr TStringArray headgearList_13= {"1.0","Random","HockeyMask",};

ref autoptr TStringArray zombieList_14 	= {"ZmbM_usSoldier_normal_Base",};
ref autoptr TStringArray itemList_14	= {"0.5","Pristine","Ammo_9x19","Ammo_9x39","AK_Suppressor","PistolSuppressor",};
ref autoptr TStringArray vestList_14 	= {"0.0","Random","",};
ref autoptr TStringArray backList_14 	= {"0.5","Random","AviatorGlasses",};
ref autoptr TStringArray headgearList_14= {"1.0","Random","MilitaryBeret_CDF","MilitaryBeret_ChDKZ","MilitaryBeret_NZ","MilitaryBeret_Red","MilitaryBeret_UN","OfficerHat",};

ref autoptr TStringArray zombieList_15 	= {"ZmbM_SoldierNormal_Base",}; 
ref autoptr TStringArray itemList_15 	= {"0.5","BadlyDamaged","AKM","Mag_AKM_30Rnd","Mag_AKM_30Rnd","Mag_AKM_30Rnd",};
ref autoptr TStringArray vestList_15 	= {"0.3","Random","HighCapacityVest_Black","PlateCarrierVest", "SmershVest","UKAssVest_Black","UKAssVest_Camo",};
ref autoptr TStringArray backList_15 	= {"0.3","Random","AssaultBag_Black","AssaultBag_Green","AssaultBag_Ttsko","DesignerGlasses",};
ref autoptr TStringArray headgearList_15= {"0.3","Random","GasMask",};

ref autoptr TStringArray zombieList_16 	= {"ZmbM_HermitSkinny_Beige",};
ref autoptr TStringArray itemList_16 	= {"1.0","Ruined","Worm","AthleticShoes_Blue","CombatBoots_Grey","HikingBootsLow_Blue","JoggingShoes_Violet","JungleBoots_Brown","Sneakers_Red","Wellies_Brown","WorkingBoots_Yellow",};  
ref autoptr TStringArray vestList_16 	= {"0.0","Ruined","",};  /// GhillieHood_Tan (tete) / GhillieBushrag_Tan (epaules) / GhillieTop_Tan (buste) / GhillieSuit_Tan (total)
ref autoptr TStringArray backList_16 	= {"0.9","Ruined","GhillieBushrag_Tan","GhillieSuit_Tan","GhillieTop_Tan","GhillieBushrag_Mossy","GhillieSuit_Mossy","GhillieTop_Mossy","GhillieBushrag_Woodland","GhillieSuit_Woodland","GhillieTop_Woodland","GhillieBushrag_Tan","GhillieBushrag_Mossy","GhillieBushrag_Woodland","GhillieBushrag_Tan","GhillieBushrag_Mossy","GhillieBushrag_Woodland",}; 
ref autoptr TStringArray headgearList_16= {"0.75","Ruined","GhillieHood_Tan","GhillieHood_Mossy","GhillieHood_Woodland",}; 

ref autoptr TStringArray zombieList_17 	= {"ZmbM_SkaterYoung_Base",}; 
ref autoptr TStringArray itemList_17 	= {"0.2","Pristine","Kiwi","Apple","Pear","Plum","Tomato","GreenBellPepper","Zucchini","SewingKit","WaterBottle","Rag",};
ref autoptr TStringArray vestList_17 	= {"1.0","Random","SportGlasses_Black","SportGlasses_Blue","SportGlasses_Green","SportGlasses_Orange",};
ref autoptr TStringArray backList_17 	= {"0.2","Ruined","ChildBag_Blue","ChildBag_Green","ChildBag_Red",};
ref autoptr TStringArray headgearList_17= {"0.7","Random","BaseballCap_Beige","BaseballCap_Black","BaseballCap_CMMG_Black","BaseballCap_Olive","SkateHelmet_Black","SkateHelmet_Blue","SkateHelmet_Gray","SkateHelmet_Green","SkateHelmet_Red",};

ref autoptr TStringArray zombieList_18 	= {"ZmbF_SkaterYoung_Base",}; 
ref autoptr TStringArray itemList_18 	= {"0.2","Pristine","HockeyStick","Apple","Pear","Plum","Tomato","GreenBellPepper","Zucchini","SewingKit","WaterBottle","Rag",};
...
ref autoptr TStringArray headgearList_18= {"0.5","Random","BaseballCap_CMMG_Pink","BaseballCap_Pink","BaseballCap_Red","BaseballCap_Blue",};
...
ref autoptr TStringArray zombieList_21 	= {"ZmbM_MechanicSkinny_Base","ZmbF_BlueCollarFat_Blue",}; 				
...
ref autoptr TStringArray itemList_30 	= {"0.0","Pristine","",};
