...
ref autoptr TIntArray data_CountrySide =	{ 1,		100,		300,		5,			7,			300,		5,				100,				1 };			// 1 DEFAULT (Countryside)

ref autoptr TIntArray data_SmallTwon =		{ 10,		10,			15,			2,			5,			100,		3,				30,					10 };			// 10 SmallTwon
ref autoptr TIntArray data_AverageTown =	{ 20,		15,			20,			3,			7,			100,		5,				30,					20 };			// 20 AverageTown
...
ref autoptr TIntArray data_Fog =			{ 70,		5,			10,			2,			3,			80,			5,				20,					70 };			// 70 Ruins
ref autoptr TIntArray data_Prison =			{ 71,		0,			0,			0,			0,			0,			0,				0,					0 };			// 71 			(always focus)
ref autoptr TIntArray data_Marines =		{ 72,		10,			15,			3,			5,			100,		10,				20,					116 };			// 72 Farm
